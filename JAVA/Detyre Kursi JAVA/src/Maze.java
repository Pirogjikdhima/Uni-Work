...
public class Maze
{
	...
	private int N;
	private final Cell[] cells; // array containing all the cells in the maze
	...
	// Kruskal's algorithm
	{
		...
		while (!ds.allConnected()) // while not all the elements in the
		// set are connected
		{
	...
	public static void main(String[] args){
		...
		for(int i = 0;i< maze.N ;i++){
			System.out.println(maze.cells[i].walls[maze.WEST]);
			System.out.println(maze.cells[i].walls[maze.EAST]);
			System.out.println(maze.cells[i].walls[maze.NORTH]);
			System.out.println(maze.cells[i].walls[maze.SOUTH]);
